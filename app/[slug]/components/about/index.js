    ...
    <section className="relative pb-40">
      <Container>
        <Grid>
          ...
          <div className="col-start-5 col-end-7 flex flex-col gap-5">
            <Col title={'Sector'} data={data?.info?.industry} />
            <Col title={'Scope'} data={data?.info?.scope} />
          </div>

          <div className="col-start-7 col-end-9 flex flex-col gap-5">
          ...
          <div className="col-start-9 col-end-13 flex flex-col gap-1">
